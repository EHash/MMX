...
wb_mux
  #(.num_slaves (2),
    .MATCH_ADDR ({32'h00000000, 32'h10000000}),
    .MATCH_MASK ({32'hffff0000, 32'hffffff00}))
 wb_mux_picorv32
   (.wb_clk_i  (wb_clk_i),
    .wb_rst_i  (wb_rst_i),
    ...
    .wbs_adr_o ({wb_ram_adr_o, wb_leds_adr_o}),
    .wbs_dat_o ({wb_ram_dat_o, wb_leds_dat_o}),
    .wbs_sel_o ({wb_ram_sel_o, wb_leds_sel_o}),
    .wbs_we_o  ({wb_ram_we_o, wb_leds_we_o}),
    .wbs_cyc_o ({wb_ram_cyc_o, wb_leds_cyc_o}),
    .wbs_stb_o ({wb_ram_stb_o, wb_leds_stb_o}),
    .wbs_cti_o ({wb_ram_cti_o, wb_leds_cti_o}),
    .wbs_bte_o ({wb_ram_bte_o, wb_leds_bte_o}),
    .wbs_dat_i ({wb_ram_dat_i, wb_leds_dat_i}),
    .wbs_ack_i ({wb_ram_ack_i, wb_leds_ack_i}),
    .wbs_err_i ({wb_ram_err_i, wb_leds_err_i}),
    .wbs_rty_i ({wb_ram_rty_i, wb_leds_rty_i}));
